...
## [0.5.0] - 2022-08-11
### Added
- Some math operations support (+, -, \*, /, %)

### Changed
- Logical AND now has greater precedence over logical OR
- **BC-BREAKING** New methods added to the `Algebra` interface
...
[0.5.0]: https://github.com/f3ath/jessie/compare/0.4.2...0.5.0
